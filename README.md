...
-  **基础与算法**
    ...
    - [06丨 数据分析基本概念](./06-09/README06.md)
    - [07丨 用户画像](./06-09/README07.md)
    - [08丨 数据采集](./06-09/README08.md)
    - [09丨 数据采集-八爪鱼](./06-09/README09.md)
    - [10丨 数据采集-Python爬虫](./10/README.md)
    - [11丨 数据清洗](./11/README.md)
    - [12丨 数据集成](./12/README.md)
    - [13丨 数据变换](./13/README.md)
...
- **场景实战**
    ...
    - [39丨数据挖掘实战（1）：信用卡违约率分析（随机森林+调参）](./39/README.md)
    - [40丨数据挖掘实战（2）：信用卡诈骗分析（逻辑回归）](./40/README.md)
    - [41丨数据挖掘实战（3）：如何对比特币走势进行预测？(时间序列预测)](./41/README.md)
    - [42丨当我们谈深度学习的时候，我们都在谈什么？(神经网络)](./42/README.md)
